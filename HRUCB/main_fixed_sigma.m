...
config.config_20arms_icml_HRUCB_fixed_sigma
    ...
    for i = 1:T
        ...
        switch alg
            ...
            case 'HR-UCB-fixed-sigma'
                [thetaHat, armChosen] = HR_UCB_fixed_sigma(beta, xi, d, lambda, L, contexts, sContexts(1:sContexts_count,:), sRewards(1:sContexts_count,1), sigmaMax2, objective);
            otherwise
